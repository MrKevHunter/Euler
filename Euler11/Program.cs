...
namespace Euler11
{
    internal class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            Console.WriteLine("Max Horizontal is {0}",maxHorizontal);
            int maxVertical = GetMaxVertical();
            Console.WriteLine("Max Vertical is {0}", maxVertical);
            int maxDiagonal = GetMaxDiagonal();
            Console.WriteLine("Max Diagonal is {0}", maxDiagonal);
            Console.ReadLine();
        }
        ...
        private static int GetMaxDiagonal()
        {
            ...
            for (int i = 0; i < 20-4; i++)
            {
                ...
                {
                    int total = ar[j][i] * ar[j + 1][i+1] * ar[j + 2][i+2] * ar[j + 3][i+3];
                    runningTotal = Math.Max(total, runningTotal);
                }
            }
            for (int i = 19; i > 4; i--)
            {
        ...
        private static int GetMaxVertical()
        {
            int runningTotal = 0;
            for (int i = 0; i < 20-4; i++)
            {
                for (int j = 0; j < 20; j++)
                {
                    int total = ar[i][j]*ar[i + 1][j]*ar[i + 2][j]*ar[i + 3][j];
                    runningTotal = Math.Max(total, runningTotal);
                }
            }
            return runningTotal;
        ...
        private static int GetMaxHorizontal()
        {
            int runningTotal = 0;
            for (int i = 0; i < 20; i++)
            {
                for (int j = 0; j < 20-4; j++)
                {
                    int total = ar[i][j]*ar[i][j + 1]*ar[i][j + 2]*ar[i][j + 3];
                    runningTotal = Math.Max(total, runningTotal);
                }
            }
            return runningTotal;
